...
export const FORMATIONS = {
  '4-3-3': {
    ...
    slots: [
      { id: 'pos_1',  role: 'POR', label: 'POR', x: 50, y: 92, defaultRole: 'POR' },
      { id: 'pos_2',  role: 'TD',  label: 'TD',  x: 86, y: 70, defaultRole: 'TD' },
      { id: 'pos_3',  role: 'DC',  label: 'DCD', x: 62, y: 71, defaultRole: 'DC' },
      { id: 'pos_4',  role: 'DC',  label: 'DCS', x: 38, y: 71, defaultRole: 'DC' },
      { id: 'pos_5',  role: 'TS',  label: 'TS',  x: 14, y: 70, defaultRole: 'TS' },
      { id: 'pos_6',  role: 'M',   label: 'MED', x: 50, y: 48, defaultRole: 'M' },
      { id: 'pos_7',  role: 'C',   label: 'MZD', x: 73, y: 39, defaultRole: 'C' },
      { id: 'pos_8',  role: 'C',   label: 'MZS', x: 27, y: 39, defaultRole: 'C' },
      { id: 'pos_9',  role: 'W',   label: 'AD',  x: 82, y: 19, defaultRole: 'W' },
      { id: 'pos_10', role: 'PC',  label: 'PC',  x: 50, y: 13, defaultRole: 'PC' },
      { id: 'pos_11', role: 'W',   label: 'AS',  x: 18, y: 19, defaultRole: 'W' }
    ],
    connections: [
  ...
  '4-4-2': {
    ...
    slots: [
      ...
      { id: 'pos_4',  role: 'DC',  label: 'DCS', x: 38, y: 71, defaultRole: 'DC' },
      { id: 'pos_5',  role: 'TS',  label: 'TS',  x: 14, y: 70, defaultRole: 'TS' },
      { id: 'pos_6',  role: 'E',   label: 'ED',  x: 87, y: 37, defaultRole: 'E' },
      { id: 'pos_7',  role: 'C',   label: 'CCD', x: 62, y: 44, defaultRole: 'C' },
      { id: 'pos_8',  role: 'C',   label: 'CCS', x: 38, y: 44, defaultRole: 'C' },
      { id: 'pos_9',  role: 'E',   label: 'ES',  x: 13, y: 37, defaultRole: 'E' },
      { id: 'pos_10', role: 'PC',  label: 'PCD', x: 62, y: 14, defaultRole: 'PC' },
      { id: 'pos_11', role: 'A',   label: 'PCS', x: 38, y: 14, defaultRole: 'A' }
    ],
    connections: [
      ['pos_1', 'pos_3'], ['pos_1', 'pos_4'],
      ['pos_5', 'pos_4'], ['pos_4', 'pos_3'], ['pos_3', 'pos_2'],
  ...
  '4-2-3-1': {
    ...
    slots: [
      ...
      { id: 'pos_4',  role: 'DC',  label: 'DCS', x: 38, y: 71, defaultRole: 'DC' },
      { id: 'pos_5',  role: 'TS',  label: 'TS',  x: 14, y: 70, defaultRole: 'TS' },
      { id: 'pos_6',  role: 'M',   label: 'MED-D', x: 64, y: 48, defaultRole: 'M' },
      { id: 'pos_7',  role: 'M',   label: 'MED-S', x: 36, y: 48, defaultRole: 'M' },
      { id: 'pos_8',  role: 'W',   label: 'TRQ-D', x: 82, y: 27, defaultRole: 'W' },
      { id: 'pos_9',  role: 'T',   label: 'TRQ-C', x: 50, y: 26, defaultRole: 'T' },
      { id: 'pos_10', role: 'W',   label: 'TRQ-S', x: 18, y: 27, defaultRole: 'W' },
  ...
  '3-5-2': {
    ...
    slots: [
      { id: 'pos_1',  role: 'POR', label: 'POR', x: 50, y: 92, defaultRole: 'POR' },
      { id: 'pos_2',  role: 'DC',  label: 'BR-D', x: 74, y: 70, defaultRole: 'DC' },
      { id: 'pos_3',  role: 'DC',  label: 'LIB',  x: 50, y: 70, defaultRole: 'DC' },
      { id: 'pos_4',  role: 'DC',  label: 'BR-S', x: 26, y: 70, defaultRole: 'DC' },
      { id: 'pos_5',  role: 'E',   label: 'ED',   x: 88, y: 37, defaultRole: 'E' },
      { id: 'pos_6',  role: 'C',   label: 'MZD',  x: 69, y: 42, defaultRole: 'C' },
      { id: 'pos_7',  role: 'M',   label: 'REG',  x: 50, y: 48, defaultRole: 'M' },
      { id: 'pos_8',  role: 'C',   label: 'MZS',  x: 31, y: 42, defaultRole: 'C' },
      { id: 'pos_9',  role: 'E',   label: 'ES',   x: 12, y: 37, defaultRole: 'E' },
      { id: 'pos_10', role: 'PC',  label: 'PCD',  x: 62, y: 14, defaultRole: 'PC' },
      { id: 'pos_11', role: 'A',   label: 'PCS',  x: 38, y: 14, defaultRole: 'A' }
    ],
    connections: [
  ...
  '3-4-2-1': {
    ...
    slots: [
      ...
      { id: 'pos_3',  role: 'DC',  label: 'LIB',  x: 50, y: 70, defaultRole: 'DC' },
      { id: 'pos_4',  role: 'DC',  label: 'BR-S', x: 26, y: 70, defaultRole: 'DC' },
      { id: 'pos_5',  role: 'E',   label: 'ED',   x: 88, y: 40, defaultRole: 'E' },
      { id: 'pos_6',  role: 'C',   label: 'CCD',  x: 63, y: 48, defaultRole: 'C' },
      { id: 'pos_7',  role: 'C',   label: 'CCS',  x: 37, y: 48, defaultRole: 'C' },
      { id: 'pos_8',  role: 'E',   label: 'ES',   x: 12, y: 40, defaultRole: 'E' },
      { id: 'pos_9',  role: 'T',   label: 'TRQ-D', x: 66, y: 26, defaultRole: 'T' },
      { id: 'pos_10', role: 'T',   label: 'TRQ-S', x: 34, y: 26, defaultRole: 'T' },
      { id: 'pos_11', role: 'PC',  label: 'PC',    x: 50, y: 13, defaultRole: 'PC' }
    ],
    connections: [
      ['pos_1', 'pos_3'], ['pos_4', 'pos_3'], ['pos_3', 'pos_2'],
  ...
  '4-3-1-2': {
    ...
    slots: [
      ...
      { id: 'pos_4',  role: 'DC',  label: 'DCS', x: 38, y: 71, defaultRole: 'DC' },
      { id: 'pos_5',  role: 'TS',  label: 'TS',  x: 14, y: 70, defaultRole: 'TS' },
      { id: 'pos_6',  role: 'M',   label: 'REG', x: 50, y: 50, defaultRole: 'M' },
      { id: 'pos_7',  role: 'C',   label: 'MZD', x: 73, y: 40, defaultRole: 'C' },
      { id: 'pos_8',  role: 'C',   label: 'MZS', x: 27, y: 40, defaultRole: 'C' },
      { id: 'pos_9',  role: 'T',   label: 'TRQ', x: 50, y: 27, defaultRole: 'T' },
      { id: 'pos_10', role: 'PC',  label: 'PCD', x: 62, y: 14, defaultRole: 'PC' },
      { id: 'pos_11', role: 'A',   label: 'PCS', x: 38, y: 14, defaultRole: 'A' }
    ],
    connections: [
  ...
  '4-4-1-1': {
    ...
    slots: [
      ...
      { id: 'pos_4',  role: 'DC',  label: 'DCS', x: 38, y: 71, defaultRole: 'DC' },
      { id: 'pos_5',  role: 'TS',  label: 'TS',  x: 14, y: 70, defaultRole: 'TS' },
      { id: 'pos_6',  role: 'E',   label: 'ED',  x: 87, y: 38, defaultRole: 'E' },
      { id: 'pos_7',  role: 'C',   label: 'CCD', x: 62, y: 46, defaultRole: 'C' },
      { id: 'pos_8',  role: 'C',   label: 'CCS', x: 38, y: 46, defaultRole: 'C' },
      { id: 'pos_9',  role: 'E',   label: 'ES',  x: 13, y: 38, defaultRole: 'E' },
      { id: 'pos_10', role: 'T',   label: 'SP',  x: 50, y: 26, defaultRole: 'T' },
      { id: 'pos_11', role: 'PC',  label: 'PC',  x: 50, y: 13, defaultRole: 'PC' }
    ],
    connections: [
      ['pos_1', 'pos_3'], ['pos_1', 'pos_4'],
  ...
  '5-3-2': {
    ...
    slots: [
      { id: 'pos_1',  role: 'POR', label: 'POR', x: 50, y: 92, defaultRole: 'POR' },
      { id: 'pos_2',  role: 'TD',  label: 'TD',  x: 88, y: 69, defaultRole: 'TD' },
      { id: 'pos_3',  role: 'DC',  label: 'DCD', x: 69, y: 71, defaultRole: 'DC' },
      { id: 'pos_4',  role: 'DC',  label: 'LIB', x: 50, y: 71, defaultRole: 'DC' },
      { id: 'pos_5',  role: 'DC',  label: 'DCS', x: 31, y: 71, defaultRole: 'DC' },
      { id: 'pos_6',  role: 'TS',  label: 'TS',  x: 12, y: 69, defaultRole: 'TS' },
      { id: 'pos_7',  role: 'C',   label: 'CCD', x: 70, y: 40, defaultRole: 'C' },
      { id: 'pos_8',  role: 'M',   label: 'REG', x: 50, y: 48, defaultRole: 'M' },
      { id: 'pos_9',  role: 'C',   label: 'CCS', x: 30, y: 40, defaultRole: 'C' },
      { id: 'pos_10', role: 'PC',  label: 'PCD', x: 62, y: 14, defaultRole: 'PC' },
      { id: 'pos_11', role: 'A',   label: 'PCS', x: 38, y: 14, defaultRole: 'A' }
    ],
    connections: [
  ...
  '5-4-1': {
    ...
    slots: [
      ...
      { id: 'pos_5',  role: 'DC',  label: 'DCS', x: 31, y: 71, defaultRole: 'DC' },
      { id: 'pos_6',  role: 'TS',  label: 'TS',  x: 12, y: 69, defaultRole: 'TS' },
      { id: 'pos_7',  role: 'E',   label: 'ED',  x: 87, y: 38, defaultRole: 'E' },
      { id: 'pos_8',  role: 'C',   label: 'CCD', x: 62, y: 46, defaultRole: 'C' },
      { id: 'pos_9',  role: 'C',   label: 'CCS', x: 38, y: 46, defaultRole: 'C' },
      { id: 'pos_10', role: 'E',   label: 'ES',  x: 13, y: 38, defaultRole: 'E' },
      { id: 'pos_11', role: 'PC',  label: 'PC',  x: 50, y: 13, defaultRole: 'PC' }
    ],
    connections: [
      ['pos_1', 'pos_4'], ['pos_6', 'pos_5'], ['pos_5', 'pos_4'], ['pos_4', 'pos_3'], ['pos_3', 'pos_2'],
