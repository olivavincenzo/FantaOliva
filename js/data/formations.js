...
export const FORMATIONS = {
  '4-3-3': {
    ...
    slots: [
      ...
      { id: 'pos_2',  role: 'TD',  label: 'TD',  x: 84, y: 72, defaultRole: 'TD' },
      { id: 'pos_3',  role: 'DC',  label: 'DCD', x: 62, y: 74, defaultRole: 'DC' },
      { id: 'pos_4',  role: 'DC',  label: 'DCS', x: 38, y: 74, defaultRole: 'DC' },
      { id: 'pos_5',  role: 'TS',  label: 'TS',  x: 16, y: 72, defaultRole: 'TS' },
      { id: 'pos_6',  role: 'M',   label: 'MED', x: 50, y: 56, defaultRole: 'M' },
      { id: 'pos_7',  role: 'C',   label: 'MZD', x: 72, y: 48, defaultRole: 'C' },
      { id: 'pos_8',  role: 'C',   label: 'MZS', x: 28, y: 48, defaultRole: 'C' },
      { id: 'pos_9',  role: 'W',   label: 'AD',  x: 82, y: 26, defaultRole: 'W' },
      { id: 'pos_10', role: 'PC',  label: 'PC',  x: 50, y: 16, defaultRole: 'PC' },
      { id: 'pos_11', role: 'W',   label: 'AS',  x: 18, y: 26, defaultRole: 'W' }
    ],
    connections: [
  ...
  '4-4-2': {
    ...
    slots: [
      ...
      { id: 'pos_4',  role: 'DC',  label: 'DCS', x: 38, y: 74, defaultRole: 'DC' },
      { id: 'pos_5',  role: 'TS',  label: 'TS',  x: 16, y: 72, defaultRole: 'TS' },
      { id: 'pos_6',  role: 'E',   label: 'ED',  x: 84, y: 48, defaultRole: 'E' },
      { id: 'pos_7',  role: 'C',   label: 'CCD', x: 62, y: 52, defaultRole: 'C' },
      { id: 'pos_8',  role: 'C',   label: 'CCS', x: 38, y: 52, defaultRole: 'C' },
      { id: 'pos_9',  role: 'E',   label: 'ES',  x: 16, y: 48, defaultRole: 'E' },
      { id: 'pos_10', role: 'PC',  label: 'PCD', x: 62, y: 18, defaultRole: 'PC' },
      { id: 'pos_11', role: 'A',   label: 'PCS', x: 38, y: 18, defaultRole: 'A' }
    ],
    connections: [
      ['pos_1', 'pos_3'], ['pos_1', 'pos_4'],
      ['pos_5', 'pos_4'], ['pos_4', 'pos_3'], ['pos_3', 'pos_2'],
  ...
  '4-2-3-1': {
    ...
    slots: [
      ...
      { id: 'pos_4',  role: 'DC',  label: 'DCS', x: 38, y: 74, defaultRole: 'DC' },
      { id: 'pos_5',  role: 'TS',  label: 'TS',  x: 16, y: 72, defaultRole: 'TS' },
      { id: 'pos_6',  role: 'M',   label: 'MED-D', x: 62, y: 58, defaultRole: 'M' },
      { id: 'pos_7',  role: 'M',   label: 'MED-S', x: 38, y: 58, defaultRole: 'M' },
      { id: 'pos_8',  role: 'W',   label: 'TRQ-D', x: 80, y: 36, defaultRole: 'W' },
      { id: 'pos_9',  role: 'T',   label: 'TRQ-C', x: 50, y: 34, defaultRole: 'T' },
      { id: 'pos_10', role: 'W',   label: 'TRQ-S', x: 20, y: 36, defaultRole: 'W' },
      { id: 'pos_11', role: 'PC',  label: 'PC',    x: 50, y: 16, defaultRole: 'PC' }
    ],
    connections: [
      ['pos_1', 'pos_3'], ['pos_1', 'pos_4'],
      ['pos_5', 'pos_4'], ['pos_4', 'pos_3'], ['pos_3', 'pos_2'],
  ...
  '3-5-2': {
    ...
    slots: [
      ...
      { id: 'pos_6',  role: 'C',   label: 'MZD',  x: 66, y: 52, defaultRole: 'C' },
      { id: 'pos_7',  role: 'M',   label: 'REG',  x: 50, y: 56, defaultRole: 'M' },
      { id: 'pos_8',  role: 'C',   label: 'MZS',  x: 34, y: 52, defaultRole: 'C' },
      { id: 'pos_9',  role: 'E',   label: 'ES',   x: 12, y: 48, defaultRole: 'E' },
      { id: 'pos_10', role: 'PC',  label: 'PCD',  x: 62, y: 18, defaultRole: 'PC' },
      { id: 'pos_11', role: 'A',   label: 'PCS',  x: 38, y: 18, defaultRole: 'A' }
    ],
    connections: [
  ...
  '3-4-2-1': {
    ...
    slots: [
      ...
      { id: 'pos_6',  role: 'C',   label: 'CCD',  x: 62, y: 56, defaultRole: 'C' },
      { id: 'pos_7',  role: 'C',   label: 'CCS',  x: 38, y: 56, defaultRole: 'C' },
      { id: 'pos_8',  role: 'E',   label: 'ES',   x: 12, y: 50, defaultRole: 'E' },
      { id: 'pos_9',  role: 'T',   label: 'TRQ-D', x: 65, y: 32, defaultRole: 'T' },
      { id: 'pos_10', role: 'T',   label: 'TRQ-S', x: 35, y: 32, defaultRole: 'T' },
      { id: 'pos_11', role: 'PC',  label: 'PC',    x: 50, y: 16, defaultRole: 'PC' }
    ],
    connections: [
      ['pos_1', 'pos_3'], ['pos_4', 'pos_3'], ['pos_3', 'pos_2'],
  ...
  '3-4-3': {
    ...
    slots: [
      ...
      { id: 'pos_3',  role: 'DC',  label: 'LIB',  x: 50, y: 76, defaultRole: 'DC' },
      { id: 'pos_4',  role: 'DC',  label: 'BR-S', x: 26, y: 74, defaultRole: 'DC' },
      { id: 'pos_5',  role: 'E',   label: 'ED',   x: 88, y: 52, defaultRole: 'E' },
      { id: 'pos_6',  role: 'C',   label: 'CCD',  x: 62, y: 56, defaultRole: 'C' },
      { id: 'pos_7',  role: 'C',   label: 'CCS',  x: 38, y: 56, defaultRole: 'C' },
      { id: 'pos_8',  role: 'E',   label: 'ES',   x: 12, y: 52, defaultRole: 'E' },
      { id: 'pos_9',  role: 'W',   label: 'AD',   x: 82, y: 26, defaultRole: 'W' },
      { id: 'pos_10', role: 'PC',  label: 'PC',   x: 50, y: 16, defaultRole: 'PC' },
      { id: 'pos_11', role: 'W',   label: 'AS',   x: 18, y: 26, defaultRole: 'W' }
    ],
  ...
  '4-3-1-2': {
    ...
    slots: [
      ...
      { id: 'pos_7',  role: 'C',   label: 'MZD', x: 72, y: 50, defaultRole: 'C' },
      { id: 'pos_8',  role: 'C',   label: 'MZS', x: 28, y: 50, defaultRole: 'C' },
      { id: 'pos_9',  role: 'T',   label: 'TRQ', x: 50, y: 34, defaultRole: 'T' },
      { id: 'pos_10', role: 'PC',  label: 'PCD', x: 62, y: 18, defaultRole: 'PC' },
      { id: 'pos_11', role: 'A',   label: 'PCS', x: 38, y: 18, defaultRole: 'A' }
    ],
    connections: [
  ...
  '4-4-1-1': {
    ...
    slots: [
      ...
      { id: 'pos_4',  role: 'DC',  label: 'DCS', x: 38, y: 74, defaultRole: 'DC' },
      { id: 'pos_5',  role: 'TS',  label: 'TS',  x: 16, y: 72, defaultRole: 'TS' },
      { id: 'pos_6',  role: 'E',   label: 'ED',  x: 84, y: 50, defaultRole: 'E' },
      { id: 'pos_7',  role: 'C',   label: 'CCD', x: 62, y: 54, defaultRole: 'C' },
      { id: 'pos_8',  role: 'C',   label: 'CCS', x: 38, y: 54, defaultRole: 'C' },
      { id: 'pos_9',  role: 'E',   label: 'ES',  x: 16, y: 50, defaultRole: 'E' },
      { id: 'pos_10', role: 'T',   label: 'SP',  x: 50, y: 32, defaultRole: 'T' },
      { id: 'pos_11', role: 'PC',  label: 'PC',  x: 50, y: 16, defaultRole: 'PC' }
    ],
    connections: [
      ['pos_1', 'pos_3'], ['pos_1', 'pos_4'],
  ...
  '5-3-2': {
    ...
    slots: [
      ...
      { id: 'pos_7',  role: 'C',   label: 'CCD', x: 68, y: 50, defaultRole: 'C' },
      { id: 'pos_8',  role: 'M',   label: 'REG', x: 50, y: 54, defaultRole: 'M' },
      { id: 'pos_9',  role: 'C',   label: 'CCS', x: 32, y: 50, defaultRole: 'C' },
      { id: 'pos_10', role: 'PC',  label: 'PCD', x: 62, y: 18, defaultRole: 'PC' },
      { id: 'pos_11', role: 'A',   label: 'PCS', x: 38, y: 18, defaultRole: 'A' }
    ],
    connections: [
