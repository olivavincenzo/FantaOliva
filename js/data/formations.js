...
export const FORMATIONS = {
  '4-3-3': {
    ...
    slots: [
      { id: 'pos_1',  role: 'POR', label: 'POR', x: 50, y: 93, defaultRole: 'POR' },
      { id: 'pos_2',  role: 'TD',  label: 'TD',  x: 87, y: 68, defaultRole: 'TD' },
      { id: 'pos_3',  role: 'DC',  label: 'DCD', x: 63, y: 69, defaultRole: 'DC' },
      { id: 'pos_4',  role: 'DC',  label: 'DCS', x: 37, y: 69, defaultRole: 'DC' },
      { id: 'pos_5',  role: 'TS',  label: 'TS',  x: 13, y: 68, defaultRole: 'TS' },
  ...
  '4-4-2': {
    ...
    slots: [
      ...
      { id: 'pos_4',  role: 'DC',  label: 'DCS', x: 37, y: 69, defaultRole: 'DC' },
      { id: 'pos_5',  role: 'TS',  label: 'TS',  x: 13, y: 68, defaultRole: 'TS' },
      { id: 'pos_6',  role: 'E',   label: 'ED',  x: 88, y: 33, defaultRole: 'E' },
      { id: 'pos_7',  role: 'C',   label: 'CCD', x: 63, y: 41, defaultRole: 'C' },
      { id: 'pos_8',  role: 'C',   label: 'CCS', x: 37, y: 41, defaultRole: 'C' },
      { id: 'pos_9',  role: 'E',   label: 'ES',  x: 12, y: 33, defaultRole: 'E' },
  ...
  '4-2-3-1': {
    ...
    slots: [
      ...
      { id: 'pos_4',  role: 'DC',  label: 'DCS', x: 37, y: 69, defaultRole: 'DC' },
      { id: 'pos_5',  role: 'TS',  label: 'TS',  x: 13, y: 68, defaultRole: 'TS' },
      { id: 'pos_6',  role: 'M',   label: 'MED-D', x: 64, y: 46, defaultRole: 'M' },
      { id: 'pos_7',  role: 'M',   label: 'MED-S', x: 36, y: 46, defaultRole: 'M' },
      ...
      { id: 'pos_11', role: 'PC',  label: 'PC',    x: 50, y: 8,  defaultRole: 'PC' }
    ],
    connections: [
      ['pos_1', 'pos_3'], ['pos_1', 'pos_4'],
      ['pos_5', 'pos_4'], ['pos_4', 'pos_3'], ['pos_3', 'pos_2'],
  ...
  '3-5-2': {
    ...
    slots: [
      { id: 'pos_1',  role: 'POR', label: 'POR', x: 50, y: 93, defaultRole: 'POR' },
      { id: 'pos_2',  role: 'DC',  label: 'BR-D', x: 74, y: 69, defaultRole: 'DC' },
      { id: 'pos_3',  role: 'DC',  label: 'LIB',  x: 50, y: 69, defaultRole: 'DC' },
      { id: 'pos_4',  role: 'DC',  label: 'BR-S', x: 26, y: 69, defaultRole: 'DC' },
  ...
  '3-4-2-1': {
    ...
    slots: [
      ...
      { id: 'pos_3',  role: 'DC',  label: 'LIB',  x: 50, y: 69, defaultRole: 'DC' },
      { id: 'pos_4',  role: 'DC',  label: 'BR-S', x: 26, y: 69, defaultRole: 'DC' },
      { id: 'pos_5',  role: 'E',   label: 'ED',   x: 90, y: 35, defaultRole: 'E' },
      { id: 'pos_6',  role: 'C',   label: 'CCD',  x: 64, y: 45, defaultRole: 'C' },
      { id: 'pos_7',  role: 'C',   label: 'CCS',  x: 36, y: 45, defaultRole: 'C' },
      { id: 'pos_8',  role: 'E',   label: 'ES',   x: 10, y: 35, defaultRole: 'E' },
      { id: 'pos_9',  role: 'T',   label: 'TRQ-D', x: 66, y: 25, defaultRole: 'T' },
      { id: 'pos_10', role: 'T',   label: 'TRQ-S', x: 34, y: 25, defaultRole: 'T' },
      { id: 'pos_11', role: 'PC',  label: 'PC',    x: 50, y: 10, defaultRole: 'PC' }
    ],
    connections: [
      ['pos_1', 'pos_3'], ['pos_4', 'pos_3'], ['pos_3', 'pos_2'],
  ...
  '3-4-3': {
    ...
    slots: [
      ...
      { id: 'pos_4',  role: 'DC',  label: 'BR-S', x: 26, y: 69, defaultRole: 'DC' },
      { id: 'pos_5',  role: 'E',   label: 'ED',   x: 90, y: 35, defaultRole: 'E' },
      { id: 'pos_6',  role: 'C',   label: 'CCD',  x: 64, y: 43, defaultRole: 'C' },
      { id: 'pos_7',  role: 'C',   label: 'CCS',  x: 36, y: 43, defaultRole: 'C' },
      { id: 'pos_8',  role: 'E',   label: 'ES',   x: 10, y: 35, defaultRole: 'E' },
      { id: 'pos_9',  role: 'W',   label: 'AD',   x: 83, y: 16, defaultRole: 'W' },
      { id: 'pos_10', role: 'PC',  label: 'PC',   x: 50, y: 11, defaultRole: 'PC' },
      { id: 'pos_11', role: 'W',   label: 'AS',   x: 17, y: 16, defaultRole: 'W' }
  ...
  '4-3-1-2': {
    ...
    slots: [
      ...
      { id: 'pos_4',  role: 'DC',  label: 'DCS', x: 37, y: 69, defaultRole: 'DC' },
      { id: 'pos_5',  role: 'TS',  label: 'TS',  x: 13, y: 68, defaultRole: 'TS' },
      { id: 'pos_6',  role: 'M',   label: 'REG', x: 50, y: 45, defaultRole: 'M' },
      { id: 'pos_7',  role: 'C',   label: 'MZD', x: 73, y: 38, defaultRole: 'C' },
      { id: 'pos_8',  role: 'C',   label: 'MZS', x: 27, y: 38, defaultRole: 'C' },
      { id: 'pos_9',  role: 'T',   label: 'TRQ', x: 50, y: 25, defaultRole: 'T' },
      { id: 'pos_10', role: 'PC',  label: 'PCD', x: 62, y: 10, defaultRole: 'PC' },
      { id: 'pos_11', role: 'A',   label: 'PCS', x: 38, y: 10, defaultRole: 'A' }
    ],
    connections: [
      ['pos_1', 'pos_3'], ['pos_1', 'pos_4'],
      ['pos_5', 'pos_4'], ['pos_4', 'pos_3'], ['pos_3', 'pos_2'],
  ...
  '4-4-1-1': {
    ...
    slots: [
      ...
      { id: 'pos_4',  role: 'DC',  label: 'DCS', x: 37, y: 69, defaultRole: 'DC' },
      { id: 'pos_5',  role: 'TS',  label: 'TS',  x: 13, y: 68, defaultRole: 'TS' },
      { id: 'pos_6',  role: 'E',   label: 'ED',  x: 88, y: 34, defaultRole: 'E' },
      { id: 'pos_7',  role: 'C',   label: 'CCD', x: 63, y: 43, defaultRole: 'C' },
      { id: 'pos_8',  role: 'C',   label: 'CCS', x: 37, y: 43, defaultRole: 'C' },
      { id: 'pos_9',  role: 'E',   label: 'ES',  x: 12, y: 34, defaultRole: 'E' },
  ...
  '5-3-2': {
    ...
    slots: [
      { id: 'pos_1',  role: 'POR', label: 'POR', x: 50, y: 93, defaultRole: 'POR' },
      { id: 'pos_2',  role: 'TD',  label: 'TD',  x: 89, y: 68, defaultRole: 'TD' },
      { id: 'pos_3',  role: 'DC',  label: 'DCD', x: 69, y: 69, defaultRole: 'DC' },
      { id: 'pos_4',  role: 'DC',  label: 'LIB', x: 50, y: 69, defaultRole: 'DC' },
      { id: 'pos_5',  role: 'DC',  label: 'DCS', x: 31, y: 69, defaultRole: 'DC' },
      { id: 'pos_6',  role: 'TS',  label: 'TS',  x: 11, y: 68, defaultRole: 'TS' },
      { id: 'pos_7',  role: 'C',   label: 'CCD', x: 71, y: 37, defaultRole: 'C' },
      { id: 'pos_8',  role: 'M',   label: 'REG', x: 50, y: 42, defaultRole: 'M' },
      { id: 'pos_9',  role: 'C',   label: 'CCS', x: 29, y: 37, defaultRole: 'C' },
      { id: 'pos_10', role: 'PC',  label: 'PCD', x: 62, y: 11, defaultRole: 'PC' },
      { id: 'pos_11', role: 'A',   label: 'PCS', x: 38, y: 11, defaultRole: 'A' }
    ],
    connections: [
  ...
  '5-4-1': {
    ...
    slots: [
      ...
      { id: 'pos_5',  role: 'DC',  label: 'DCS', x: 31, y: 69, defaultRole: 'DC' },
      { id: 'pos_6',  role: 'TS',  label: 'TS',  x: 11, y: 68, defaultRole: 'TS' },
      { id: 'pos_7',  role: 'E',   label: 'ED',  x: 88, y: 35, defaultRole: 'E' },
      { id: 'pos_8',  role: 'C',   label: 'CCD', x: 63, y: 43, defaultRole: 'C' },
      { id: 'pos_9',  role: 'C',   label: 'CCS', x: 37, y: 43, defaultRole: 'C' },
      { id: 'pos_10', role: 'E',   label: 'ES',  x: 12, y: 35, defaultRole: 'E' },
      { id: 'pos_11', role: 'PC',  label: 'PC',  x: 50, y: 11, defaultRole: 'PC' }
    ],
    connections: [
      ['pos_1', 'pos_4'], ['pos_6', 'pos_5'], ['pos_5', 'pos_4'], ['pos_4', 'pos_3'], ['pos_3', 'pos_2'],
