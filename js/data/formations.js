...
export const FORMATIONS = {
  '4-3-3': {
    ...
    slots: [
      { id: 'pos_1',  role: 'POR', label: 'POR', x: 50, y: 88, defaultRole: 'POR' },
      { id: 'pos_2',  role: 'TD',  label: 'TD',  x: 87, y: 64, defaultRole: 'TD' },
      { id: 'pos_3',  role: 'DC',  label: 'DCD', x: 63, y: 65, defaultRole: 'DC' },
      { id: 'pos_4',  role: 'DC',  label: 'DCS', x: 37, y: 65, defaultRole: 'DC' },
      { id: 'pos_5',  role: 'TS',  label: 'TS',  x: 13, y: 64, defaultRole: 'TS' },
  ...
  '4-2-3-1': {
    ...
    slots: [
      ...
      { id: 'pos_4',  role: 'DC',  label: 'DCS', x: 37, y: 65, defaultRole: 'DC' },
      { id: 'pos_5',  role: 'TS',  label: 'TS',  x: 13, y: 64, defaultRole: 'TS' },
      { id: 'pos_6',  role: 'M',   label: 'MED-D', x: 64, y: 44, defaultRole: 'M' },
      { id: 'pos_7',  role: 'M',   label: 'MED-S', x: 36, y: 44, defaultRole: 'M' },
  ...
  '3-4-2-1': {
    ...
    slots: [
      ...
      { id: 'pos_6',  role: 'C',   label: 'CCD',  x: 64, y: 44, defaultRole: 'C' },
      { id: 'pos_7',  role: 'C',   label: 'CCS',  x: 36, y: 44, defaultRole: 'C' },
  ...
  '4-3-1-2': {
    ...
    slots: [
      ...
      { id: 'pos_4',  role: 'DC',  label: 'DCS', x: 37, y: 65, defaultRole: 'DC' },
      { id: 'pos_5',  role: 'TS',  label: 'TS',  x: 13, y: 64, defaultRole: 'TS' },
      { id: 'pos_6',  role: 'M',   label: 'REG', x: 50, y: 44, defaultRole: 'M' },
  ...
  '5-3-2': {
    ...
    slots: [
      { id: 'pos_1',  role: 'POR', label: 'POR', x: 50, y: 88, defaultRole: 'POR' },
      { id: 'pos_2',  role: 'TD',  label: 'TD',  x: 89, y: 64, defaultRole: 'TD' },
      { id: 'pos_3',  role: 'DC',  label: 'DCD', x: 69, y: 65, defaultRole: 'DC' },
      { id: 'pos_4',  role: 'DC',  label: 'LIB', x: 50, y: 65, defaultRole: 'DC' },
      { id: 'pos_5',  role: 'DC',  label: 'DCS', x: 31, y: 65, defaultRole: 'DC' },
      { id: 'pos_6',  role: 'TS',  label: 'TS',  x: 11, y: 64, defaultRole: 'TS' },
